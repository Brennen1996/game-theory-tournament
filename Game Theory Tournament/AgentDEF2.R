    ...
    #When the first four rounds have been played against my current opponent, I try to use his strategy against him.
      ...
      #If I am not able to figure out the strategy of my opponent, I decide which of my own strategies I will use this round.  
        ...
        if ((round_number_opp / 4) > choice_maker){
          ...
          round = self$my_actions_vs_opponent$round
          n = max(round)
          round2 = head(round, -1)
          n2 = max(round2)
          round3 = head(round, -2)
          ...
          #checks if I am in a loop with a player who plays tit for tat and try to break the loop. 
          last = self$my_actions_vs_opponent[self$my_actions_vs_opponent$round == n, "opp_bid"]
          my_last = self$my_actions_vs_opponent[self$my_actions_vs_opponent$round == n, "my_bid"]
          
          one_before_last = self$my_actions_vs_opponent[self$my_actions_vs_opponent$round == n2, "opp_bid"]
          one_before_my_last = self$my_actions_vs_opponent[self$my_actions_vs_opponent$round == n2, "my_bid"]
          
          two_before_last = self$my_actions_vs_opponent[self$my_actions_vs_opponent$round == n3, "opp_bid"]
          two_before_my_last = self$my_actions_vs_opponent[self$my_actions_vs_opponent$round == n3, "my_bid"]
          
          if (two_before_last != two_before_my_last) {
            if (one_before_last != one_before_my_last) {
              if (last != my_last) {
                bid = "cooperate"
              } else {
                bid = last
